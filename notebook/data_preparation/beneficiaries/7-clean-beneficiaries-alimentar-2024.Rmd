...
#Clean
```{r}
bind_rows(external_beneficiaries_alimentar_octubre_2024, external_beneficiaries_alimentar_septiembre_2024, external_beneficiaries_alimentar_agosto_2024,
...
#Save
```{r}
write.csv(interim_beneficiaries_alimentar_2024,"./interim_beneficiaries_alimentar_20245.csv")
drive_update(as_id("1jKxj_n6jTIV7OP7EKgx4MOyOWXL7qSUK"),"./interim_beneficiaries_alimentar_2024.csv")
file.remove("./interim_beneficiaries_alimentar_20245.csv")
```
