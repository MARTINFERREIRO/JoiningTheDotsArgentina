...
```{r}
#Cotizaciones
file_url<-"https://drive.google.com/uc?export=download&id=144nzhMVvP0ovw77ieiwfhH9ig_UTc2vW"
...
file_url<-"https://drive.google.com/uc?export=download&id=1yXHug1EGeI2ZXJZRSexMVMQKvOOwhLDv"
file_content <- drive_download(file = as_id(file_url), overwrite = TRUE)
read_csv(file_content$local_path)->external_contributions_2019_2025
file.remove( file_content$local_path)

file_url<-"https://drive.google.com/uc?export=download&id=1FdZmQR0TScYVBADli_YQTTdvFsMZqWCU"
file_content <- drive_download(file = as_id(file_url), overwrite = TRUE)
read_csv(file_content$local_path)->external_contributions_2019_2025
file.remove( file_content$local_path)
```
...
drive_update(as_id("1cK0lrE-MzjF1dZav_-8e9Q11Q8OHLoSb"),"../../../data/processed/contributions/processed_contributions_2011_2025.csv")
file.remove("../../../data/processed/contributions/processed_contributions_2011_2025.csv")
