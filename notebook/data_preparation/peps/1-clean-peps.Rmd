...
```{r}
#Autoridades apn
file_url<-"https://drive.google.com/uc?export=download&id=1VcDgmUe69TO6Bp9lug203c0lFpYTMVck"
file_content <- drive_download(file = as_id(file_url), overwrite = TRUE)
read_csv(file_content$local_path) |> 
  mutate(periodo = "2025-07-01")->external_autoridades_apn_julio_2025
...
```{r}
#Ejecutivo nacional
external_autoridades_apn_julio_2025 |> 
  bind_rows(external_autoridades_apn_junio_2025) |>
  ...
  left_join(external_autoridades_apn_junio_2025 |> distinct(autoridad_dni, periodo), by = c("dni_pep"="autoridad_dni")) |>
  ...
  select(-periodo,-periodo.x,-periodo.y,-periodo.y.y,-periodo.x.x) |> 
...
#Save
```{r}
write_csv(processed_peps_2019_2025,"./processed_peps_2019_2025.csv")
drive_update(as_id("1tQGlgS3qDTnQZhCLD4f-LdVwuL3_DV0Z"),"./processed_peps_2019_2025.csv")
file.remove("./processed_peps_2019_2025.csv")
```
